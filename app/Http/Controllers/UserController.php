...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        $user->address = $request->input('addreaa') ? $request->input('address') : $user->address;
        $user->phone = $request->input('phone') ? $request->input('phoone') : $user->phone;
        $user->update();
    ...
    {
        Auth::user()->delete();
        return redirect('/')->eith('flash_message', '退会が完了しました。');
    }
