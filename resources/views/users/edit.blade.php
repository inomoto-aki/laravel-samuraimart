...
<div class="container">
   <div class="row justify-content-center">
       <div class="col-md-5">
           ...
           <hr>
           <div class="d-flew justify-content-start">
            <form method="POST" action="{{ route('mypage.destroy') }}">
                ...
                <div class="modal fade" id="delete-user-confirm-modal" data-bacckdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
